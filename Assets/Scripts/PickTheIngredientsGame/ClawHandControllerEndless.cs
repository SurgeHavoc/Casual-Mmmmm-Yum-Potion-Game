...
public class ClawHandControllerEndless : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        {
            GameManagerEndless.Instance.ClawHandControllerInstance = this;
        }
    }
    ...
    void Update()
    {
        if (GameManagerEndless.Instance != null && GameManagerEndless.Instance.IsGameOver)
            return;
    ...
    void DeliverIngredient()
    {
        ...
        {
            IngredientEndless IngredientComponent = CarriedIngredient.GetComponent<IngredientEndless>();
